...
def _observation() -> VisionObservation:
    return VisionObservation(
        ...
        face_box=None,
        left_eye=EyeFeatures(None, 0.5, 0.5, NormalizedPoint(0.25, 0.4)),
        right_eye=EyeFeatures(None, 0.7, 0.5, NormalizedPoint(0.75, 0.6)),
...
def test_feature_order_and_right_eye_handedness_are_pinned() -> None:
    ...
    assert features.values == (0.25, 0.4, 0.25, 0.6, 0.5, 0.7, 3.0, -2.0, 1.0)
